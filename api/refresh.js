...
const GL_AGENCIES = ["FDA","EMA","NIH","NCI"];
...
function region(title, desc) {
  ...
  const DEFINITIVE_KR = ["국산","국내 최초","국내 허가","식약처 허가","국내 개발","식약처 승인","국내 임상 1","국내 임상 2","국내 임상 3"];
  ...
  if (domesticScore===0&&globalScore===0) { const h=(ds.match(/[가-힣]/g)||[]).length; return h/(dn.length||1)>0.7?"domestic":"global"; }
